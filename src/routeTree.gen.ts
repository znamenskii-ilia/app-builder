...
const ApplicationsApplicationIdRouteRoute = ApplicationsApplicationIdRouteImport.update({
  id: "/$applicationId",
  path: "/$applicationId",
  getParentRoute: () => ApplicationsRouteRoute,
} as any);

const ApplicationsApplicationIdIndexRoute = ApplicationsApplicationIdIndexImport.update({
  id: "/",
  path: "/",
...
declare module "@tanstack/react-router" {
  interface FileRoutesByPath {
    ...
    "/applications/$applicationId/": {
      ...
      path: "/";
      fullPath: "/applications/$applicationId/";
      preLoaderRoute: typeof ApplicationsApplicationIdIndexImport;
...
const ApplicationsApplicationIdRouteRouteWithChildren =
  ApplicationsApplicationIdRouteRoute._addFileChildren(ApplicationsApplicationIdRouteRouteChildren);
...
const ApplicationsRouteRouteWithChildren = ApplicationsRouteRoute._addFileChildren(
  ApplicationsRouteRouteChildren,
);
...
/* ROUTE_MANIFEST_START
{
  "routes": {
    ...
    "/applications/$applicationId/": {
      "filePath": "applications/$applicationId/index.tsx",
